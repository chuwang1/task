...
!     RHOA,Q0,QA (not an input parameter for tr)
  ...
  INTEGER, PARAMETER :: NCTM=111   ! Max number of save variables in globals
  ...
  INTEGER:: NTEQIT, EQRELOAD, EQAUTO, NEQAUTO, EQFAILMODE, EQSAVE, EQDEBUG
...
!       PELPAT
  ...
  CHARACTER(LEN=128) :: KNAMEQWRAP, KNAMEQSNAP, KNAMEQNEW
