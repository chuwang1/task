...
!     ***********************************************************
      ...
      !  model_arfixed: Ar density from external file
      !       0 : use PNAR (density factor)
      !       1 : read Ar density from CSV file (knam_arfixed)
      model_arfixed=0
      knam_arfixed='omfit_density_for_tr.csv'

      !  model_radfixed: radiation from external file
      !       0 : use calculated radiation (PRB+PRL+PRC)
      !       1 : read qrad from CSV file (knam_radfixed), override PRSUM
      model_radfixed=0
      knam_radfixed='omfit_qrad_for_tr.csv'
      ...
      !  model_prffixed: PRF (RF heating) from external file
      !       0 : use Gaussian profile (PECR0, PECRW, PECIN)
      !       1 : read qrfe from CSV file (knam_prffixed), override PRF_e
      model_prffixed=0
      knam_prffixed='omfit_qrfe_for_tr.csv'
      ...
      PNC     = 0.D0
      PNFE    = 0.D0
      PNAR    = 0.D0   ! Argon density factor
      ...
      HY_CORRECTION_FACTOR = 1.0D0  ! Correction for HY ion partition (1.0=no change, ~1.16 matches TRANSP)
      SIGMAV_SCALE_FACTOR = 1.0D0   ! Manual scale for DT <sigma v> (1.0=no scaling)
