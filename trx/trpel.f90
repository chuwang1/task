...
!     ***********************************************************
      ...
      WRITE(6,*) 'DEBUG TRPELA: PELIN=', PELIN(npel), ' FSUM=', FSUM, ' S0=', S0
      ...
      WRITE(6,*) 'TRPELA SPE_NSNPELNR(D, npel, :):'
      WRITE(6,'(5ES12.4)') SPE_NSNPELNR(2, npel, 1:NRMAX)
      WRITE(6,*) 'TRPELA SPE_NSNPELNR(e, npel, :):'
      WRITE(6,'(5ES12.4)') SPE_NSNPELNR(1, npel, 1:NRMAX)
